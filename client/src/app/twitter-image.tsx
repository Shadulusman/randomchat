  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <svg width="56" height="42" viewBox="0 0 120 90" fill="none">
        ...
        <div style={{ fontSize: '32px', fontWeight: 700, color: '#ffffff', marginBottom: '12px' }}>
          Free Random Video Chat
        </div>
        <div style={{ fontSize: '20px', color: '#94a3b8', maxWidth: '600px', textAlign: 'center' }}>
        ...
        >
          ...
          <div style={{ fontSize: '18px', color: '#e2e8f0', fontWeight: 600 }}>omeelo.com</div>
        </div>
      </div>
    ),
    { ...size }
